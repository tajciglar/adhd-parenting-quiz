...
const REPORT_TEMPLATES: Record<string, ArchetypeReportTemplate> = {
  ...
  "deer": {
    ...
    "innerVoiceQuote": "I feel the world so deeply that sometimes I need help finding my way through it.",
  ...
  "owl": {
    "archetypeId": "owl",
    "title": "THE KEEN OWL",
    "innerVoiceQuote": "I see everything that's happening between people. I just can't always find my place in it.",
  ...
  "octopus": {
    ...
    "innerVoiceQuote": "I feel everything, notice everything, and my body never stops. It's a lot to be me.",
  ...
  "swan": {
    ...
    "innerVoiceQuote": "I hold everything together on the surface. Underneath, I'm paddling harder than anyone knows.",
  ...
  "bunny": {
    ...
    "innerVoiceQuote": "I'm always somewhere else in my head. It's beautiful there, but I keep missing what's happening here.",
  ...
  "tender_hedgehog": {
    ...
    "innerVoiceQuote": "Everything is louder for me. But I feel the beautiful things more deeply too.",
  ...
  "hidden_firefly": {
    ...
    "innerVoiceQuote": "My light is real. I just don't always know when it's safe to let it show.",
  ...
  "panda": {
    ...
    "innerVoiceQuote": "I was just about to do it, and then I had the most incredible idea and I had to follow it immediately, obviously.",
  ...
  "firefly": {
    ...
    "innerVoiceQuote": "I feel things deeply, think beautifully, and still struggle to show it the way I mean to.",
  ...
  "penguin": {
    ...
    "innerVoiceQuote": "I start with every intention of getting there. Then my brain takes the scenic route.",
  ...
  "eagle": {
    "archetypeId": "eagle",
    "title": "THE SKY EAGLE",
    "innerVoiceQuote": "The whole picture comes easily to me. The pieces take more work.",
  ...
  "bear": {
    ...
    "innerVoiceQuote": "Sometimes my energy gets ahead of my good ideas.",
  ...
  "bee": {
    "archetypeId": "bee",
    "title": "THE BUZZY BEE",
    "innerVoiceQuote": "My brain goes where the energy is, and the energy is usually people.",
  ...
  "red_panda": {
    ...
    "title": "THE RED PANDA",
    "innerVoiceQuote": "I come close gently, because the world can feel loud before it feels safe.",
